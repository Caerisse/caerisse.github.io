...
def tabMapNotInteractive(arg: pd.DataFrame, field_name: str):
    ...
    map_arg = make_map(field_name)

    l = layout([[map_arg]]) 
    tab = Panel(child=l,title="Mapa Casos {}".format(field_name))
    return tab 
